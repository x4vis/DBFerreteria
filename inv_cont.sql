...
CREATE TABLE IF NOT EXISTS Permission (
  PermissionId INT UNSIGNED NOT NULL AUTO_INCREMEN PRIMARY KEY
  Name VARCHAR(64) NOT NULL,
...
CREATE TABLE IF NOT EXISTS UserPermission (
  ...
  CONSTRAINT UserPermissionUserFk
  FOREIGN KEY (UserId)
...
CREATE TABLE IF NOT EXISTS CashFLowType {
  CashFlowTypeId INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
